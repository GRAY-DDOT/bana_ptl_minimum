...
class _RunModelByImageDemoState extends State<RunModelByImageDemo> {
  ...
  Future loadModel() async {
    ...
    String pathObjectDetectionModel = "assets/models/yolov5_.torchscript";
    ...
    try {
      ...
      _objectModel = await PytorchLite.loadObjectDetectionModel(
          pathObjectDetectionModel, 21, 1088, 1088,
  ...
  //   //실질 적인 출력 부분
  //   //탐지 확정시
  //     //스크린샷 => 저장(날짜 시간 기준으로 저장하게끔 하거)
  //     //인식 객체 값 저장 => if 여러 개 pick high score =>
  ...
  Future runObjectDetection_camera() async {
    //pick a random image
      ...
      home: Scaffold(
        ...
        body:Column(
          ...
          children: <Widget>[
            ...
            TextButton(
              onPressed: runObjectDetection_camera,
              style: TextButton.styleFrom(
                backgroundColor: Colors.blue,
              ),
              child: const Text(
                "Run BANA Detector with Camera",
                style: TextStyle(
                  color: Colors.white,
                ),
              ),
